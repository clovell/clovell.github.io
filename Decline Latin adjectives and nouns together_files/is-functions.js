...
function checkIs() {
	...
	for (var i=0; i<15; i++) {
	    if (trimAndLower(frm1[i].value) == trimAndLower(dBaseIs[i])) {
...
function initializePageAN() {
	...
	*/
	...
	checkButtonEnabled = '<input id="checkB" onclick="checkIs()" value="' + LCheckButton + '" type="button" tabIndex="-1">';
	checkButtonDisabled = '<input id="checkB" onclick="checkIs()" value="' + LCheckButton + '" type="button" tabIndex="-1" disabled>';
	document.getElementById("checkButton").innerHTML = checkButtonEnabled;
